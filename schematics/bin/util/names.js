...
exports.pageNames = {
    ...
    askInterface: (name) => `AskFor${core_1.strings.classify(name)}PageDto`,
    askConstant: (name) => `ASK_FOR_${core_1.strings.underscore(name).toUpperCase()}_PAGE_DTO`,
    askKindConstant: (name) => `ASK_FOR_${core_1.strings.underscore(name).toUpperCase()}_PAGE_DTO_KIND`,
    ...
    dtoFile: (name) => `${core_1.strings.dasherize(name)}.dto.ts`,
    dtoFileNoExt: (name) => `${core_1.strings.dasherize(name)}.dto`,
