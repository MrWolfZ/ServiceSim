...
export const pageNames = {
  ...
  askInterface: (name: string) => `AskFor${strings.classify(name)}PageDto`,
  askConstant: (name: string) => `ASK_FOR_${strings.underscore(name).toUpperCase()}_PAGE_DTO`,
  askKindConstant: (name: string) => `ASK_FOR_${strings.underscore(name).toUpperCase()}_PAGE_DTO_KIND`,
  ...
  dtoFile: (name: string) => `${strings.dasherize(name)}.dto.ts`,
  dtoFileNoExt: (name: string) => `${strings.dasherize(name)}.dto`,
