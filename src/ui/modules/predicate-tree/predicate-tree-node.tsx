...
export const PredicateTreeNodeDef = (state: PredicateTreeNodeState, { nodeId, isFocused }: PredicateTreeNodeProps, { router }: StatefulComponentContext) => {
...
export const PredicateTreeNode = stateful(PredicateTreeNodeDef, initialState, propsDefinition, {
