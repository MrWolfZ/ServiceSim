...
export function eventStream<TEvent extends DomainEvent<TEvent['kind']> = DomainEvent>(
...
export async function publishAsync(
  ...
  // ensure the events are persisted to disk before making them visible inside the app
